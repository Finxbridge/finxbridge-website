...
export default async function ProductPage() {
  const content = await loadContent<ProductContent>('product-capabilities.json')
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">{content.solutions.title}</h2>
            <p className="text-xl text-dark-light max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">{content.process.title}</h2>
            <p className="text-xl text-dark-light max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">{content.technologies.title}</h2>
            <p className="text-xl text-dark-light max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {content.technologies.categories.map((tech, index) => (
