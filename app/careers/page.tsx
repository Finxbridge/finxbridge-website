...
export default async function CareersPage() {
  const content = await loadContent<CareersContent>('careers.json')
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">{content.whyJoinUs.title}</h2>
            <p className="text-xl text-dark-light max-w-3xl mx-auto">
              {content.whyJoinUs.subtitle}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {content.whyJoinUs.highlights.map((item, index) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-dark mb-4">{content.openPositions.title}</h2>
            <p className="text-xl text-dark-light max-w-3xl mx-auto">
              {content.openPositions.subtitle}
            </p>
          </div>

          <div className="space-y-6">
            {content.openPositions.positions.map((position, index) => (
