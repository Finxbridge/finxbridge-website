  ...
  return (
    ...
    >
      <div className="container-custom">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            <Image
              ...
              width={120}
              height={60}
              className="object-contain w-20 h-10 md:w-28 md:h-14 lg:w-32 lg:h-16 transition-all duration-300"
              style={{
        ...
        {/* Mobile Menu */}
        <div
          className={`lg:hidden fixed top-0 right-0 h-screen w-72 sm:w-80 bg-white shadow-2xl transform transition-transform duration-300 overflow-y-auto ${
        ...
        >
          ...
          <button
            ...
            className="absolute top-4 right-4 w-12 h-12 flex items-center justify-center rounded-full bg-primary/10 hover:bg-primary hover:text-white text-primary transition-all duration-300 z-10"
          ...
          <div className="flex flex-col p-6 sm:p-8 gap-4 mt-20">
            {menuItems.map((item) => (
              item.dropdown ? (
                <div key={item.label}>
                  <button
