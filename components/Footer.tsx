        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-dark-light mb-4 leading-relaxed">
              Empowering financial innovation with expert fintech solutions for banks,
              NBFCs, and fintechs across India.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-dark-light/20 rounded-lg flex items-center justify-center hover:bg-primary transition-colors duration-300"
